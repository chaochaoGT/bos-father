...
<div data-options="region:'center'">
	<form id="menuForm" method="post" action="${pageContext.request.contextPath }/menu/menuAction_save">
...
<!-- 					</tr> -->
					...
					<tr>
						...
						<td>
							...
							url:'${pageContext.request.contextPath}/menu/menuAction_ajaxListHasSonMenus'"/>
						</td>
					</tr>
					<tr>
						<td>菜单描述</td>
