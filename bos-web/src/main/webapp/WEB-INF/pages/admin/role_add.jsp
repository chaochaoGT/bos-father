...
<script type="text/javascript">
	$(function(){
		...
		//  权限数据checkbox生成
		 $.post("${pageContext.request.contextPath}/function/functionAction_ajaxList",function(data){
			 $(data).each(function(){
				 //  List<Function>
...
<body class="easyui-layout">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="roleForm" action="${pageContext.request.contextPath }/role/roleAction_save" method="post">
