...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#grid").datagrid({
			...
			onDblClickRow:function(rowIndex,rowData){
				//  权限列表回显
				  $("#functionIds").empty();
					$.ajax({
					url : '${pageContext.request.contextPath}/function/functionAction_ajaxList',
					type : 'POST',
					dataType : 'json',
					success : function(data) {
							 $(data).each(function(){
								...
								$.ajax({
									url : '${pageContext.request.contextPath}/function/functionAction_findFunctionByRoleId',
									type : 'POST',
				...
				$.ajax({
					url : '${pageContext.request.contextPath}/menu/menuAction_ajaxList',
					type : 'POST',
					dataType : 'text',
					success : function(data) {
			...
			url : '${pageContext.request.contextPath}/role/roleAction_pageQuery',
			columns : [[
				{
					field : 'id',
					title : '编号',
	 ...
	 function loadNodes(roleId){
         $.ajax({
           type:"post",
           url:"${pageContext.request.contextPath}/menu/menuAction_findMenuByRoleId",
           data:{"roleId":roleId},
           async:false,
           dataType:"json",
           success:function(data){
