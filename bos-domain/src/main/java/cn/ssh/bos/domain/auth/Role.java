package cn.ssh.bos.domain.auth;
// Generated 2017-7-31 10:24:40 by Hibernate Tools 3.2.2.GA
...
public class Role implements java.io.Serializable {
    ...
    @JoinTable(name = "role_menu", catalog = "day15", joinColumns = {
    ...
    @ManyToMany( fetch = FetchType.LAZY)
    @JoinTable(name = "role_function", catalog = "day15", joinColumns = {
            @JoinColumn(name = "role_id", nullable = false, updatable = false)}, inverseJoinColumns = {
